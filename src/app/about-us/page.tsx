...
export default function AboutUs() {
  return (
    <main className='text-center space-y-24 py-12'>
      <h1 className='uppercase font-editorial-new normal font-light text-center text-6xl xs:text-7xl sm:text-8xl'>
      ...
      <section className='lg:hidden space-y-24 flex flex-col items-center'>
        ...
        <div className='space-y-14 p-6 xs:p-8'>
          {EQUIPO.map(({ slug, position, name }) => (
            <div key={slug} className='space-y-2'>
              <p className='font-editorial-new uppercase font-extralight text-2xl xs:text-3xl sm:text-4xl'>
                {position}
              </p>
      ...
      <section className='hidden lg:flex flex-col p-14'>
        <Heading as='h2' className='w-[600px] lg:w-[1000px] xl:w-[1200px] m-auto italic text-6xl md:text-6xl text-left'>
          Equipo
        </Heading>
        ...
        <div className='w-[600px] lg:w-[1000px] xl:w-[1200px] m-auto flex gap-14'>
          <div className='w-1/2 space-y-14 text-end'>
            ...
            <div className='space-y-14 inline-flex flex-col text-right'>
          ...
          <div className='w-1/2 space-y-14 text-start'>
            <div className='space-y-14 inline-flex flex-col relative w-[100%]'>
