  ...
  return (
    <main>
      <section className='mb-12'>
        ...
        <article className='relative text-left p-[1.75em] mt-20 mb-16 mx-6 xs:mx-12 sm:mx-20 md:mx-32 lg:mx-72 bg-white font-editorial-new font-extralight text-base md:text-xl w-fit max-w-[270px] xs:max-w-[320px] md:max-w-[400px]'>
